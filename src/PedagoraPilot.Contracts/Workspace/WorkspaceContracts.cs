...
public sealed record WorkspaceSiteDto(Guid Id, string Key, Guid OrganizationId, string OrganizationKey, string Code, string Name, string City, bool Active);
...
public sealed record CreateTrainingSiteRequest(string Code, string Name, string City, string? ExternalKey);
