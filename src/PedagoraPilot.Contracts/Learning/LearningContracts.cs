...
public sealed record PedagogicalTopicDto(Guid Id, Guid ReferentialVersionId, string Code, int? Number, string Title, string Category, int DurationMinutes, string? Reference, bool Active);
public sealed record LearnerTopicProgressDto(Guid Id, Guid EnrollmentId, Guid TopicId, string Code, int? Number, string Title, string Category, string Status, DateOnly? PreparationDate, DateOnly? PresentationDate, int? PresentationDurationMinutes, string? EvaluatorDisplayName, string? Comment);
public sealed record UpdateTopicProgressRequest(string Status, DateOnly? PreparationDate, DateOnly? PresentationDate, int? PresentationDurationMinutes, string? EvaluatorDisplayName, string? Comment);
